...
def login():
    ...
    # Colocar a segunda condição porque os dois formularios estão na msm página
...
def atualizar_cursos(form):
    ...
    return ';'.join(lista_cursos) # devolve nesse formato 'curso1;curso2;curso3'
